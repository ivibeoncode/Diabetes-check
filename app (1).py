...
with col2:
    chol_mgdl = st.number_input(
        ...
        min_value=50.0, max_value=600.0, value=174.0, step=1.0,
        help="Total serum cholesterol level in mg/dL (standard Indian lab format)."
    )
    tg_mgdl = st.number_input(
        "Triglycerides (mg/dL)",
        min_value=10.0, max_value=1800.0, value=106.0, step=1.0,
        help="Serum triglyceride level in mg/dL (standard Indian lab format)."
    )
...
if st.button("Predict Diabetes Risk"):
    # Convert mg/dL to mmol/L (model trained on mmol/L)
